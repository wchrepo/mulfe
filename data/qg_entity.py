...
model = TransformersQG(model='lmqg/t5-base-squad-qg',model_ae="ner")
...
with open(path+".lmqg_ner",'w') as f:
    json.dump(result_data,f,ensure_ascii=False,indent=2)

# import json
# with open("eval_data/mulfe_test.json.lmqg_ner") as f:
...
# with open("eval_data/mulfe_test.json.lmqg_ner",'w') as f:
#     json.dump(result_data,f,ensure_ascii=False,indent=2)
